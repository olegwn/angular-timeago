...
]).directive('timeAgo', ['timeAgo', 'timeAgoShort', 'nowTime', function (timeAgo, timeAgoShort, nowTime) {
  return {
    scope : {
      fromTime : '@',
      format : '@',
    ...
    link: function(scope, elem) {
      ...
      if(scope.shortFormat) {
        angular.element(elem).text(timeAgoShort.inWords(value, fromTime, scope.format));
      } else {
...
}]).factory('timeAgoShort', ['$filter', function ($filter) {
  var service = {};
